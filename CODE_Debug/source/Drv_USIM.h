...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ 共用變量 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#define  UART_LENGTH_TX	40	// 協議中最大的長度 40
#define  UART_LENGTH_RX	16	// 協議中最大的長度
struct DrvUartFormat_t
{
    unsigned char TxBuf[UART_LENGTH_TX];    // RW
    unsigned char RxBuf[UART_LENGTH_RX];    // RW
    unsigned char RXState;
    unsigned char RXState_ESP8266;
    unsigned char RxTimeOutCnt_ESP8266;
    //unsigned char TxCycle;
    unsigned char TxLength;
    unsigned char RxCycle1;
    unsigned char RxCycle2;
    union {
		struct
		{
